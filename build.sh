...
if [[ $HELP == true ]]; then
	...
	echo ""
	echo "Example:"
	echo "  docker run {IMAGE:VERSION} -v /project:/app"
	echo "  docker run {IMAGE:VERSION} -r https://github.com/jasonyang-ee/STM32-CMAKE-TEMPLATE.git"
	echo "  docker run {IMAGE:VERSION} -v /project:/app -r https://github.com/jasonyang-ee/STM32-CMAKE-TEMPLATE.git -t Debug"
	echo ""
